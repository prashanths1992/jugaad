...
Hide details
Change log
r450 by haineault on Feb 4, 2009   Diff
- jquery.countdown.js: fixed IE bug
(trailing coma.. thanks vince :D)
- jquery.arrayUtils.js: fixed IE bug with
single dimension arrays and pluck
- code cleanup
- fixed unit tests (now passes with IE7)
Go to: 	
Sign in to write a code review
Older revisions
 r422 by haineault on Jan 8, 2009   Diff 
 r418 by haineault on Jan 8, 2009   Diff 
 r185 by haineault on Sep 9, 2008   Diff 
All revisions of this file
File info
Size: 4560 bytes, 128 lines
View raw file
File properties
svn:executable
*
